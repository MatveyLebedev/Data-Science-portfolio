...
1. Predicting heating problems for buildings. Powered by catboost. Uses home and heating data. Designed for hackathon "Digital transformation leaders hackathon 2024".
...
4. News selection systems for the profile feed from hackathon "MORE.tech 4.0".
...
5. Comments classifier and EDA for comments from social networks. Based on BERT, TF-IDF and CatBoost:
...
6. Detection function arguments from description for generation advisez for programmer.
...
7. Robot-dog with computer wision.
